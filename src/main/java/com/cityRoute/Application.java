...
public class Application {
    ...
    public String isConnected(
        ...
        CityPath originCity = county.getCity(origin.toUpperCase());
        CityPath destCity = county.getCity(destination.toUpperCase());

        Objects.requireNonNull(originCity);
        Objects.requireNonNull(destCity);

        
        return ConnectedPath.commute(originCity, destCity)?"Yes":"No";
    }
    ...
    public String info() {
        ...
        Collection<CityPath> cities = county.getCityMap().values();
        for (CityPath city : cities) {
            html.append("<li>")
                    .append(city.getName())
                    .append(" &rarr; ")
