...
public class CityMap {
    ...
    private Map<String, CityPath> cityMap = new HashMap<>();
    ...
    public Map<String, CityPath> getCityMap() {
        return cityMap;
    }
    ...
    private void read() throws IOException {
        ...
        while (scanner.hasNext()) {
            ...
            if (!Akey.equals(Bkey)) {
                CityPath A = cityMap.getOrDefault(Akey, CityPath.build(Akey));
                CityPath B = cityMap.getOrDefault(Bkey, CityPath.build(Bkey));
    ...
    public CityPath getCity(String name) {
